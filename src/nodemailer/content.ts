...
export const RSVP_CONFIRMATION_HTML_NOT_COMING_GB = table(
  RSV_CONFIRMATION_HEADER_GB,
  'We are really sorry to hear that you won\'t be able to make it. We\'ll keep you in our thoughts and hope to see you soon!',
)

export const RSVP_CONFIRMATION_HTML_NOT_COMING_IT = table(
  RSV_CONFIRMATION_HEADER_IT,
  'Ci dispiace molto che non riuscite a venire. Speriamo di riuscire a vederci presto in qualche altra occasione!',
)
